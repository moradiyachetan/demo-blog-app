        ...
        $(function () {
            ...
            var table = $('.data-table').DataTable({
                ...
                stateSaveCallback: function (settings, data) {
                    localStorage.setItem('category_Datatable_' + settings.sInstance, JSON.stringify(data))
                },
                stateLoadCallback: function (settings) {
                    return JSON.parse(localStorage.getItem('category_Datatable_' + settings.sInstance))
                },
                ajax: {
