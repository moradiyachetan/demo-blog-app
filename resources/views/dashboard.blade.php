            ...
            <div class="card-box">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-6">
                        ...
                        <h3 class="mt-0 font-20 text-truncate">$98,741 <small class="badge badge-light-danger font-13">-5%</small>
                        </h3>
                    </div>
                </div>

                <div class="mt-5">
                    <span data-plugin="peity-line" data-fill="#56c2d6" data-stroke="#4297a6" data-width="100%"
                          data-height="50">3,5,2,9,7,2,5,3,9,6,5,9,7</span>
                </div>
                            ...
                            <div class="row text-center">
                                <div class="col-md-4">
                                    ...
                                    <h2 class="font-weight-normal mb-3">
                                        <small
                                            class="mdi mdi-checkbox-blank-circle text-muted align-middle mr-1"></small>
                ...
                <div class="card-body">
                    <div class="media align-items-center">
                        <div class="media-body">
                            ...
                            <h3 class="m-0 font-weight-normal text-white sp-line-1 cta-box-title">Special launcing <b>Discount</b>
                                offer</h3>
                            <p class="text-light mt-2 sp-line-2">Suspendisse vel quam malesuada, aliquet sem sit amet,
                    ...
                    <div id="cardCollpase4" class="collapse pt-3 show">
                        <div class="row">
                            ...
                            <div class="col-md-4 align-self-center">
                                <h5 class="mb-1 mt-0">1,12,540 <small
                                        class="text-muted ml-2">www.getbootstrap.com</small></h5>
                                ...
                                <h5 class="mb-1 mt-0">45,760 <small class="text-muted ml-2">www.dribbble.com</small>
                                </h5>
                                <div class="progress-w-percent">
                            ...
                            <div class="timeline-alt">
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-item-info">
                                        <a href="#" class="text-body font-weight-semibold mb-1 d-block">You sold an
                                            item</a>
                                ...
                                <div class="timeline-item">
                                    <i class="timeline-icon"></i>
                                    <div class="timeline-item-info">
                                        <a href="#" class="text-body font-weight-semibold mb-1 d-block">Product on the
                                            Bootstrap Market</a>
                                ...
                                <div class="timeline-item">
                                    <i class="timeline-icon"></i>
                                    <div class="timeline-item-info">
                                        <a href="#" class="text-body font-weight-semibold mb-1 d-block">Robert
                                            Delaney</a>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-item-info">
                                        ...
                                        <small>Uploaded a photo
                                            <span class="font-weight-semibold">"Error.jpg"</span> Please change folder
                                            structure.
                                        </small>
                                        <p>
